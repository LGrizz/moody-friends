...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch ([[[[user objectForKey:@"tweets"] objectAtIndex:indexPath.row] objectForKey:@"sentiment"] integerValue]) {
        case -1:
            cell.contentView.backgroundColor = [UIColor colorWithRed:51.0f/255.0f green:153.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
            break;
        case 0:
            cell.contentView.backgroundColor = [UIColor colorWithRed:255.0f/255.0f green:255.0f/255.0f blue:255.0f/255.0f alpha:1.0f];
            break;
        case 1:
            cell.contentView.backgroundColor = [UIColor colorWithRed:255.0f/255.0f green:255.0f/255.0f blue:102.0f/255.0f alpha:1.0f];
            break;
        default:
            break;
    }
